...
if __name__ == '__main__':
    ...
    parser.add_argument('--ft_network', type=str, default=f'./outputs/PX/network-snapshot-000030.pkl')
    parser.add_argument('--dw', type=str, default=f'./outputs/PX/network-snapshot-000030-w.pkl')
    parser.add_argument('--output', type=str, default=f'./outputs/PX')
